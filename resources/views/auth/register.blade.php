        ...
        <div class="signup">
            <div class="content">
                <div class="signup_form">
                    ...
                    <x-guest-layout>
                        <form method="POST" action="{{ route('registerSeller') }}" id="myForm"
                            ...
                            <div class="role mt-3">
                                ...
                                <select id="role" class="block mt-1 w-full" name="role" style="width: 100%; padding: 7px;">
                            ...
                            <div class="phone mt-3">
                                ...
                                <input type="text" id="phone" name="phone_number" value="{{old('phone_number') }}"
                                    placeholder="Enter Your Phone Number" class="block mt-1 w-full">
                                <x-input-error :messages="$errors->get('phone')" class="mt-2" />
                            </div>

                            <!-- SSN -->
                            <div class="ssn mt-3">
                                <label for="ssn" class="d-block">SSN</label>
                                <input type="text" id="ssn" name="ssn" value="{{old('snn') }}" placeholder="Enter Your SSN"
