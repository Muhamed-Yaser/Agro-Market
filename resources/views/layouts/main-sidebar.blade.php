  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="height: 100vh;width: 20%">
      <!-- Brand Logo -->
              ...
              <div class="info">
                  <a href="#" class="d-block">
                      {{-- @auth('admin')
                          ...
                          <a href="{{ route('dashboard.profile.edit') }}" class="btn btn-info mt-2">Edit Profile</a>
                      @else
                          <script>
